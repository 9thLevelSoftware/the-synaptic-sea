...
**Spec:** `docs/superpowers/specs/2026-06-20-sargasso-core-systems-design.md` — System 1: "Generate life raft + one derelict type. Validate: rooms connect, geometry loads, player can walk through."
