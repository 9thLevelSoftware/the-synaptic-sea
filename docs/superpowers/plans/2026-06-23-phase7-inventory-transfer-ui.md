...
```bash
echo 'SYNAPTIC_SEA REGRESSION PASS commands=114 clean_output=true'
```
...
git stash pop
```
Expected tail: `SYNAPTIC_SEA REGRESSION PASS commands=114 clean_output=true`. Do not commit or revert the `project.godot` drift.
