...
**Goal:** Build the first player-controllable generated-ship prototype slice for The Sargasso of Stars.
...
- The workspaces are not git repositories at plan time. Each task includes a commit-or-log step that commits when git exists and otherwise appends exact changed paths to `/tmp/sargasso_playable_no_git_changes.log`.
...
- `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/player/player_controller.gd`
  - Owns placeholder player movement, interact input, collision body setup, and a test helper for scripted movement.
- `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/camera/iso_camera_rig.gd`
  - Owns the locked-isometric follow camera. Does not parse procgen data.
- `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/interaction/interactable.gd`
  - Owns player-in-range detection and interact completion signals for objective/portal targets.
- `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/procgen/playable_generated_ship.gd`
  - Coordinates loader, player, camera, objective tracker, and interactable nodes for the playable generated-ship slice.
- `/Users/christopherwilloughby/the-sargasso-of-stars/scenes/procgen/playable_generated_ship.tscn`
  - Minimal scene resource that attaches `PlayableGeneratedShip`.
- `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/validation/playable_component_smoke.gd`
  - Headless component smoke for player, camera, and interactable scripts.
- `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/validation/procgen_playable_ship_smoke.gd`
  - Headless playable generated-ship smoke.
- `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/validation/procgen_playable_ship_capture.gd`
  - Headless-or-windowed capture proof for the playable scene.

### Modified Godot files

- `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/procgen/generated_ship_loader.gd`
...
- `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/ui/objective_tracker.gd`
  - Add completion query helpers used by playable validation.
- `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/main.gd`
...
- Expected missing for RED: `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/validation/procgen_playable_ship_smoke.gd`
...
GODOT_PROJECT = Path("/Users/christopherwilloughby/the-sargasso-of-stars")
...
if git -C /Users/christopherwilloughby/off-the-rails-ai-infra rev-parse --is-inside-work-tree >/dev/null 2>&1; then
  ...
  printf '%s\n' 'NO_GIT Task 1 changed: /Users/christopherwilloughby/off-the-rails-ai-infra/tests/test_godot_procgen_playable_ship.py' >> /tmp/sargasso_playable_no_git_changes.log
fi
```

Expected when no git repo is present: command exits 0 and appends the path to `/tmp/sargasso_playable_no_git_changes.log`.
...
**Files:**
- Create: `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/player/player_controller.gd`
- Create: `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/camera/iso_camera_rig.gd`
- Create: `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/interaction/interactable.gd`
- Create: `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/validation/playable_component_smoke.gd`
...
Write this complete file to `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/player/player_controller.gd`:
...
Write this complete file to `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/camera/iso_camera_rig.gd`:
...
Write this complete file to `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/interaction/interactable.gd`:
...
Write this complete file to `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/validation/playable_component_smoke.gd`:
...
if git -C /Users/christopherwilloughby/the-sargasso-of-stars rev-parse --is-inside-work-tree >/dev/null 2>&1; then
  git -C /Users/christopherwilloughby/the-sargasso-of-stars add scripts/player/player_controller.gd scripts/camera/iso_camera_rig.gd scripts/interaction/interactable.gd scripts/validation/playable_component_smoke.gd
  git -C /Users/christopherwilloughby/the-sargasso-of-stars commit -m "feat: add playable prototype components"
else
  printf '%s\n' 'NO_GIT Task 2 changed: /Users/christopherwilloughby/the-sargasso-of-stars/scripts/player/player_controller.gd /Users/christopherwilloughby/the-sargasso-of-stars/scripts/camera/iso_camera_rig.gd /Users/christopherwilloughby/the-sargasso-of-stars/scripts/interaction/interactable.gd /Users/christopherwilloughby/the-sargasso-of-stars/scripts/validation/playable_component_smoke.gd' >> /tmp/sargasso_playable_no_git_changes.log
fi
```

Expected when no git repo is present: command exits 0 and appends the paths to `/tmp/sargasso_playable_no_git_changes.log`.
...
- Modify: `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/ui/objective_tracker.gd`
- Create: `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/validation/procgen_loader_playable_contract_smoke.gd`
...
Append this exact block to the end of `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/procgen/generated_ship_loader.gd`:
...
Append this exact block to the end of `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/ui/objective_tracker.gd`:
...
Write this complete file to `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/validation/procgen_loader_playable_contract_smoke.gd`:
...
```bash
if git -C /Users/christopherwilloughby/the-sargasso-of-stars rev-parse --is-inside-work-tree >/dev/null 2>&1; then
  git -C /Users/christopherwilloughby/the-sargasso-of-stars add scripts/procgen/generated_ship_loader.gd scripts/ui/objective_tracker.gd scripts/validation/procgen_loader_playable_contract_smoke.gd
  git -C /Users/christopherwilloughby/the-sargasso-of-stars commit -m "feat: expose generated ship playable contract"
else
  printf '%s\n' 'NO_GIT Task 3 changed: /Users/christopherwilloughby/the-sargasso-of-stars/scripts/procgen/generated_ship_loader.gd /Users/christopherwilloughby/the-sargasso-of-stars/scripts/ui/objective_tracker.gd /Users/christopherwilloughby/the-sargasso-of-stars/scripts/validation/procgen_loader_playable_contract_smoke.gd' >> /tmp/sargasso_playable_no_git_changes.log
fi
```
...
**Files:**
- Create: `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/procgen/playable_generated_ship.gd`
- Create: `/Users/christopherwilloughby/the-sargasso-of-stars/scenes/procgen/playable_generated_ship.tscn`
...
Write this complete file to `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/procgen/playable_generated_ship.gd`:
...
Write this complete file to `/Users/christopherwilloughby/the-sargasso-of-stars/scenes/procgen/playable_generated_ship.tscn`:

```text
[gd_scene load_steps=2 format=3 uid="uid://sargasso_playable_generated_ship"]
...
```bash
if git -C /Users/christopherwilloughby/the-sargasso-of-stars rev-parse --is-inside-work-tree >/dev/null 2>&1; then
  git -C /Users/christopherwilloughby/the-sargasso-of-stars add scripts/procgen/playable_generated_ship.gd scenes/procgen/playable_generated_ship.tscn
  git -C /Users/christopherwilloughby/the-sargasso-of-stars commit -m "feat: add playable generated ship scene"
else
  printf '%s\n' 'NO_GIT Task 4 changed: /Users/christopherwilloughby/the-sargasso-of-stars/scripts/procgen/playable_generated_ship.gd /Users/christopherwilloughby/the-sargasso-of-stars/scenes/procgen/playable_generated_ship.tscn' >> /tmp/sargasso_playable_no_git_changes.log
fi
```
...
**Files:**
- Create: `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/validation/procgen_playable_ship_smoke.gd`
- Create: `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/validation/procgen_playable_ship_capture.gd`
...
Expected: FAIL because `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/validation/procgen_playable_ship_smoke.gd` is missing.

- [ ] **Step 2: Create `procgen_playable_ship_smoke.gd`**

Write this complete file to `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/validation/procgen_playable_ship_smoke.gd`:
...
Write this complete file to `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/validation/procgen_playable_ship_capture.gd`:
...
```bash
mkdir -p /tmp/sargasso_playable_ship
/Users/christopherwilloughby/.local/bin/godot-4.6.2 --headless \
  --path /Users/christopherwilloughby/the-sargasso-of-stars \
  --script res://scripts/validation/procgen_playable_ship_capture.gd -- \
  --output /tmp/sargasso_playable_ship/playable-ship-capture.png \
  --capture-frame 240
python3 - <<'PY'
from pathlib import Path
p = Path('/tmp/sargasso_playable_ship/playable-ship-capture.png')
...
```text
PLAYABLE SHIP CAPTURE PASS output=/tmp/sargasso_playable_ship/playable-ship-capture.png
...
```bash
if git -C /Users/christopherwilloughby/the-sargasso-of-stars rev-parse --is-inside-work-tree >/dev/null 2>&1; then
  git -C /Users/christopherwilloughby/the-sargasso-of-stars add scripts/validation/procgen_playable_ship_smoke.gd scripts/validation/procgen_playable_ship_capture.gd
  git -C /Users/christopherwilloughby/the-sargasso-of-stars commit -m "test: add playable generated ship smoke"
else
  printf '%s\n' 'NO_GIT Task 5 changed: /Users/christopherwilloughby/the-sargasso-of-stars/scripts/validation/procgen_playable_ship_smoke.gd /Users/christopherwilloughby/the-sargasso-of-stars/scripts/validation/procgen_playable_ship_capture.gd' >> /tmp/sargasso_playable_no_git_changes.log
fi
```
...
**Files:**
- Modify: `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/main.gd`
...
Expected before this task: output contains `The Sargasso of Stars project bootstrap loaded.` and may reference `GeneratedShipDemo` through runtime demo load output. This confirms the main scene is runnable before changing it.

- [ ] **Step 2: Replace `scripts/main.gd` with playable-scene launcher**

Write this complete file to `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/main.gd`:
...
func _ready() -> void:
	print("The Sargasso of Stars playable prototype bootstrap loaded.")
...
```text
The Sargasso of Stars playable prototype bootstrap loaded.
PLAYABLE SHIP READY player_spawned=true camera_spawned=true objectives=4
```
...
/Users/christopherwilloughby/.local/bin/godot-4.6.2 --headless \
  ...
  --layout /Users/christopherwilloughby/the-sargasso-of-stars/data/procgen/smoke/seed_000017/layout.json \
  --kit /Users/christopherwilloughby/the-sargasso-of-stars/data/kits/ship_structural_v0.json \
  --gameplay-slice /Users/christopherwilloughby/the-sargasso-of-stars/data/procgen/smoke/seed_000017/gameplay_slice.json \
  --timeout-frames 9000
...
/Users/christopherwilloughby/.local/bin/godot-4.6.2 --headless \
  --path /Users/christopherwilloughby/the-sargasso-of-stars \
  --script res://scripts/validation/procgen_playable_ship_capture.gd -- \
  --output /tmp/sargasso_playable_ship/final-playable-ship-capture.png \
  --capture-frame 240
python3 - <<'PY'
from pathlib import Path
p = Path('/tmp/sargasso_playable_ship/final-playable-ship-capture.png')
print(f'capture_exists={p.exists()} size_bytes={p.stat().st_size if p.exists() else 0} path={p}')
raise SystemExit(0 if p.exists() and p.stat().st_size > 0 else 1)
PY
```
...
```text
PLAYABLE SHIP CAPTURE PASS output=/tmp/sargasso_playable_ship/final-playable-ship-capture.png
capture_exists=True size_bytes=
```
...
```bash
if git -C /Users/christopherwilloughby/the-sargasso-of-stars rev-parse --is-inside-work-tree >/dev/null 2>&1; then
  git -C /Users/christopherwilloughby/the-sargasso-of-stars add scripts/main.gd
  git -C /Users/christopherwilloughby/the-sargasso-of-stars commit -m "feat: launch playable generated ship prototype"
else
  printf '%s\n' 'NO_GIT Task 6 changed: /Users/christopherwilloughby/the-sargasso-of-stars/scripts/main.gd' >> /tmp/sargasso_playable_no_git_changes.log
fi
```
