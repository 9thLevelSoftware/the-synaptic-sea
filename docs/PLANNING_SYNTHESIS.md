# The Sargasso of Stars — Planning & Design Synthesis

**Source:** `~/the-synaptic-sea/docs/`
**Project root:** `/Users/christopherwilloughby/the-sargasso-of-stars` (Godot 4.6.2)
**Working title:** *The Sargasso of Stars* — locked-isometric 3D ship survival/exploration
...
- **Working title:** *The Sargasso of Stars* (placeholder kept; main scene prints "The Sargasso of Stars coherent proof ship bootstrap loaded.").
- **Locked premise:** The player's hub ship is trapped in a vast biomatter/cosmic Sargasso. They explore procedurally generated derelicts (each one a self-contained "building") to loot, repair, occupy/fortify, defend, and ultimately fly them out. Derelicts are the buildings; ships are the explorers. Modeled in the spirit of *Project Zomboid* — open-world, persistent-location, deep systems.
...
- **Per-bundle:** `SARGASSO REGRESSION PASS commands=<N> clean_output=true` marker.
