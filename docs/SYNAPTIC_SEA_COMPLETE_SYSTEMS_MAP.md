...
| --- | --- | --- | --- | --- |
| 00 / `t_0228a857` | Kickoff / graph release | Done | board governance<br>- | Docs: docs/game/build-plans/14-cross-system-integration-review-e2e.md; docs/game/build-plans/README.md; .omh/kanban/synaptic-sea-e2e-systems-task-graph.json<br>Code/data: -<br>Validation: - |
...
| 02 / `t_d569eba2` | Food, Cooking, Spoilage & Sustenance Inputs | Validated | REQ-FC-001..010<br>ADR-0034 food/cooking/spoilage | Docs: docs/game/features/food_cooking_spoilage.md; docs/game/balance/food_cooking_spoilage_tuning.md<br>Code/data: scripts/systems/food_state.gd; spoilage_state.gd; hydroponics_state.gd; synthesizer_state.gd; water_recycler_state.gd (the standalone cooking_state/galley path was superseded by the ADR-0038 kitchen crafting station and removed; CookingState is retained only as SynthesizerState's internal state machine)<br>Validation: FOOD STATE PASS; SPOILAGE STATE PASS; HYDROPONICS STATE PASS; SYNTHESIZER STATE PASS; FOOD SAVE LOAD PASS; MAIN PLAYABLE FOOD CONSUMPTION PASS |
