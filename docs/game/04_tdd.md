...
GDAI notes:
- Sargasso-local addon path: `res://addons/gdai-mcp-plugin-godot/`.
- Hermes config runs `/Users/christopherwilloughby/.local/bin/uv run /Users/christopherwilloughby/the-sargasso-of-stars/addons/gdai-mcp-plugin-godot/gdai_mcp_server.py`.
