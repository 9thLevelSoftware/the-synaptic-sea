...
`/Users/christopherwilloughby/the-synaptic-sea-of-stars/artifacts/validation-previews/locked-iso-readability.png`

## Screenshot / preview command

```bash
/Users/christopherwilloughby/.local/bin/godot-4.6.2   --windowed   --resolution 1600x900   --path /Users/christopherwilloughby/the-synaptic-sea-of-stars   --scene res://scenes/validation/locked_iso_readability_harness.tscn   --write-movie /Users/christopherwilloughby/the-synaptic-sea-of-stars/artifacts/validation-previews/locked-iso-readability.png   --quit-after 1
```
