...
- **Triage owner:** `synapse_seareview` (per `docs/game/bug_triage.md`).
...
- **Runner:** `synapse_seareview` for `t_f4c0c74e` Gate 3 Alpha entry.
...
- The "No open P0/P1 blockers in core loop" Gate 3 exit criterion is met on
  the build under review as of 2026-06-19 (run by `@synapse_seaworker`).
