...
- `.omh/kanban/sargasso-stage-gate-task-graph.json` — historical bootstrap manifest; Task 15 marks the active current manifest instead of treating this as the E2E graph.
