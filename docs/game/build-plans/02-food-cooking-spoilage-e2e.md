# Task 02: Food, Cooking, Spoilage & Sustenance Inputs — Standalone E2E Package Plan

Generated: 2026-06-25T19:59:51-04:00

## Objective
Deliver a complete, production-grade, independently testable package for **Food, Cooking, Spoilage & Sustenance Inputs**.

## Source requirements
- Package requirement range: REQ-FC-001..010
...
## Concept lock
Complete food economy: rations, scavenged food, alien flora, cooked meals, spoilage, cooking stations, synthesizer, hydroponics, water handling.

## Project Zomboid influence, translated in-character
PZ food freshness, cooking skill, farming/foraging, nutrition variety and boredom/unhappiness translated to ration fatigue and dread relief.
...
- food/drink items in item_definitions.json
- data/recipes/food/*.tres or .json
- spoilage tuning
- hydroponics crop definitions

### Required runtime integration
- container and cargo spoilage ticks
- cooking station interactable
- hydroponics growth tick
- consumable effect funnel into vitals

### Required UI/UX/player feedback
- food freshness badges in inventory
- cooking recipe panel
- hydroponics station panel

### Required asset/audio seams
- food icons
- galley/cooking station placeholder
- hydroponic tray placeholder
- synthesizer placeholder

### Required smoke/validation files
- food_state_smoke.gd
- spoilage_state_smoke.gd
- cooking_state_smoke.gd
- hydroponics_state_smoke.gd
- main_playable_slice_cooking_smoke.gd
- food_save_load_smoke.gd
...
## Acceptance criteria
- Fresh/Stale/Rotten stages affect hunger, sanity, and sickness risk.
- Cooking consumes real inventory ingredients and power, then produces a real consumable item.
- Hydroponics produces harvestable food through a timed cycle.
- Food state persists across save/load and ship travel.
...
- Write a short `docs/game/build-plans/evidence/food-cooking-spoilage-contract-review.md` with existing files, missing files, and chosen extension seams.
...
- Add requirement rows for REQ-FC-001..010 with status transitions: Proposed -> Approved -> Validated.
