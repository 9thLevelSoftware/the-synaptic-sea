# Task 12: Procedural Generation Expansion, Templates, Biomes & Encounter Injection — Standalone E2E Package Plan

Generated: 2026-06-25T19:59:51-04:00

## Objective
Deliver a complete, production-grade, independently testable package for **Procedural Generation Expansion, Templates, Biomes & Encounter Injection**.

## Source requirements
- Package requirement range: REQ-PG-001..012
...
## Concept lock
Expanded procgen: new templates, room variants, role-aligned kits, biome/depth/difficulty modifiers, loot placement, encounter injection, and seed determinism.

## Project Zomboid influence, translated in-character
PZ building variety, location-driven loot, zombie density variation, sandbox/difficulty settings adapted to derelict ship personality and Synaptic Sea cells.
...
- procgen kit json files
- room variant resources
- biome profiles
- difficulty presets
- encounter placement tables

### Required runtime integration
- room assigner variant extension
- structural placer multi-kit support
- template C ramp/elevator runtime
- encounter markers in layout serializer

### Required UI/UX/player feedback
- scanner marker detail for biome/difficulty/loot/threat
- debug procgen proof overlay

### Required asset/audio seams
- expanded structural modules
- room variant dressing placeholders
- biome color/lighting presets

### Required smoke/validation files
- template_c_traversal_smoke.gd
- room_variant_selector_smoke.gd
- kit_catalog_smoke.gd
- biome_profile_smoke.gd
- difficulty_profile_smoke.gd
...
## Acceptance criteria
- At least six templates/variants are deterministic by seed.
- Biome/difficulty modify hazards, loot, and encounters without breaking connectivity.
- Encounter injection emits valid threat spawn markers consumed by combat.
- Same seed hashes identical across repeated generations.
...
- Write a short `docs/game/build-plans/evidence/procedural-generation-expansion-contract-review.md` with existing files, missing files, and chosen extension seams.
...
- Add requirement rows for REQ-PG-001..012 with status transitions: Proposed -> Approved -> Validated.
