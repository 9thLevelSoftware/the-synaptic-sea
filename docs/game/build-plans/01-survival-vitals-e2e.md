# Task 01: Survival Vitals — Standalone E2E Package Plan

Generated: 2026-06-25T19:59:51-04:00

## Objective
Deliver a complete, production-grade, independently testable package for **Survival Vitals**.

## Source requirements
- Package requirement range: REQ-SV-001..008
...
## Concept lock
A full Project-Zomboid-style moodle/vitals stack adapted to space horror: oxygen, health, stamina, hunger, thirst, temperature, radiation, sanity, and their cascade rules.

## Project Zomboid influence, translated in-character
PZ moodles, hunger/thirst/fatigue/panic/stress, visible warning escalation, slow compounding failure rather than cheap sudden death.
...
- StatusEffectsState integration

### Required data/config/resources
- data/systems/vitals_tuning.tres or .gd
- data/effects/effect_definitions.json
- item effects for food/drink/medicine/stims

### Required runtime integration
- PlayableGeneratedShip._refresh_player_vitals(delta)
- PlayerVitalsPanel expansion
- RunSnapshot vitals_summary
- difficulty-preset drain scaling

### Required UI/UX/player feedback
- bottom-left full vitals panel
- severity icons/colors
- status-effect row
- critical warning flashes

### Required asset/audio seams
- placeholder HUD icons for all vitals
- severity color palette with colorblind seam

### Required smoke/validation files
- vitals_state_smoke.gd
- sanity_state_smoke.gd
- radiation_state_smoke.gd
- body_temperature_state_smoke.gd
...
- VITALS STATE PASS
- SANITY STATE PASS
- RADIATION STATE PASS
- MAIN PLAYABLE VITALS FULL PASS

## Acceptance criteria
- All vitals drain/recover under deterministic tuning.
- At least three cascade interactions are live: hunger->stamina, thirst->vision/readability, sanity->perception/hallucination pressure.
...
- Write a short `docs/game/build-plans/evidence/survival-vitals-contract-review.md` with existing files, missing files, and chosen extension seams.
...
- Add requirement rows for REQ-SV-001..008 with status transitions: Proposed -> Approved -> Validated.
