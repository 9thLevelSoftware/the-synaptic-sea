# Task 04: Loot Ecosystem, Rarity, Containers & Unique Finds — Standalone E2E Package Plan

Generated: 2026-06-25T19:59:51-04:00

## Objective
Deliver a complete, production-grade, independently testable package for **Loot Ecosystem, Rarity, Containers & Unique Finds**.

## Source requirements
- Package requirement range: REQ-LE-001..009
...
## Concept lock
Finite location-aware loot system with rarity tiers, container subtypes, depth/biome scaling, junk-to-material ecology, unique/lore items, and pickup feedback.
...
- expanded item_definitions rarity fields
- loot_tables with biome/depth/condition modifiers
- junk_items.json
- unique_items.json
- biome_definitions.json

### Required runtime integration
- LootContainer subtype handling
- procgen room-role placement
- unique drop registry
- codex unlock hook
- rarity pickup toasts

### Required UI/UX/player feedback
- rarity border in inventory rows
- loot pickup toast
- container lock/rarity indicators

### Required asset/audio seams
- container placeholders by type
- rarity color palette
- unique item icons

### Required smoke/validation files
- rarity_tier_smoke.gd
- loot_distribution_smoke.gd
- loot_table_biome_smoke.gd
- unique_item_state_smoke.gd
- junk_items_smoke.gd
- container_variety_smoke.gd
...
## Acceptance criteria
- Loot remains deterministic by seed while varying by biome, depth, condition, and container kind.
- Unique items drop once per seed/world and persist in codex/meta state.
- Junk has material value and feeds crafting.
- Loot feedback is visible/audible and accessible.
...
- Write a short `docs/game/build-plans/evidence/loot-ecosystem-contract-review.md` with existing files, missing files, and chosen extension seams.
...
- Add requirement rows for REQ-LE-001..009 with status transitions: Proposed -> Approved -> Validated.
