# Task 13: Distribution, Store, Achievements, Demo, Localization & Post-Launch Ops — Standalone E2E Package Plan

Generated: 2026-06-25T19:59:51-04:00

## Objective
Deliver a complete, production-grade, independently testable package for **Distribution, Store, Achievements, Demo, Localization & Post-Launch Ops**.

## Source requirements
- Package requirement range: REQ-RL-001..010
...
## Concept lock
Production release operations: export presets, itch/Steam paths, achievements, crash/logging, localization, Steam Deck/controller checks, demo build, credits/licensing, post-launch playbook.

## Project Zomboid influence, translated in-character
PZ-style long-tail survival release expectations: robust saves, mod/community posture, patch cadence, Steam achievements, deck-friendly controls.
...
- CrashReportBundle
- DemoScopeGate
- ReleaseReadinessLedger

### Required data/config/resources
- achievement catalog
- localization CSV/PO files
...
- localization_catalog_smoke.gd
- demo_scope_gate_smoke.gd
- release_readiness_ledger_smoke.gd

### Required PASS markers
- EXPORT PRESETS PASS
- ACHIEVEMENT STATE PASS
- LOCALIZATION CATALOG PASS
- RELEASE READINESS LEDGER PASS

## Acceptance criteria
- Export presets dry-run or validation succeeds for target platforms.
- Achievements are data-driven and triggered by real gameplay events.
- All UI strings route through localization catalog.
- Demo manifest gates content deterministically and release ledger distinguishes local vs external evidence.
...
- Write a short `docs/game/build-plans/evidence/distribution-store-postlaunch-contract-review.md` with existing files, missing files, and chosen extension seams.
...
- Add requirement rows for REQ-RL-001..010 with status transitions: Proposed -> Approved -> Validated.
