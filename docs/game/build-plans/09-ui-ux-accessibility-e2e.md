# Task 09: UI/UX, HUD, Menus, Tutorials, Controller & Accessibility — Standalone E2E Package Plan

Generated: 2026-06-25T19:59:51-04:00

## Objective
Deliver a complete, production-grade, independently testable package for **UI/UX, HUD, Menus, Tutorials, Controller & Accessibility**.

## Source requirements
- Package requirement range: REQ-UI-001..016
...
## Concept lock
Production UI shell: full HUD, menus, settings, map/minimap, tooltip system, tutorial triggers, codex, controller support, and accessibility settings.

## Project Zomboid influence, translated in-character
PZ moodle/status UI, health panel, inventory/crafting screens, map/FOW, contextual survival readability adapted to locked-isometric space UI.
...
- AccessibilitySettings expansion

### Required data/config/resources
- settings schema
- tutorial trigger definitions
- codex entries
- input glyph tables
- accessibility preset definitions

### Required runtime integration
- main menu/pause/settings routing
- HUD panel layout manager
- minimap/map update
- context prompt resolver
- tutorial trigger events
...
- controller glyph placeholders
- tutorial art placeholders

### Required smoke/validation files
- menu_state_smoke.gd
- settings_state_smoke.gd
- tooltip_presenter_smoke.gd
- tutorial_state_smoke.gd
- map_fog_state_smoke.gd
...
## Acceptance criteria
- Every core menu is navigable by keyboard/mouse and controller.
- HUD exposes all critical survival/combat/ship information without overlap.
- Accessibility options apply at runtime and persist.
- Tutorials trigger once, can be skipped, and unlock codex help.
...
- Write a short `docs/game/build-plans/evidence/ui-ux-accessibility-contract-review.md` with existing files, missing files, and chosen extension seams.
...
- Add requirement rows for REQ-UI-001..016 with status transitions: Proposed -> Approved -> Validated.
