# Task 11: Save/Load, Persistence, Multi-Slot, Auto-Save & Cloud Readiness — Standalone E2E Package Plan

Generated: 2026-06-25T19:59:51-04:00

## Objective
Deliver a complete, production-grade, independently testable package for **Save/Load, Persistence, Multi-Slot, Auto-Save & Cloud Readiness**.

## Source requirements
- Package requirement range: REQ-SL-001..012
...
## Concept lock
Production persistence layer: multi-slot saves, auto/quick save, save UI, corruption checks, migrations, meta/run/world separation, death/permadeath, cloud-ready manifests.

## Project Zomboid influence, translated in-character
PZ persistent world/permadeath model translated to persistent sector/hub, run snapshots, recoverable wreck/corpse, and new-run continuity.
...
- migration table
- cloud manifest
- death epitaph schema

### Required runtime integration
- SaveLoadService multi-slot expansion
- menu save/load UI
...
- save/load menu
- continue/quick-save indicators
- death/epitaph review panel

### Required asset/audio seams
- save slot thumbnails or placeholder captures
- saving indicator icon

### Required smoke/validation files
- save_slot_state_smoke.gd
- save_index_state_smoke.gd
- save_migration_service_smoke.gd
- autosave_policy_smoke.gd
- permadeath_resolver_smoke.gd
...
## Acceptance criteria
- Manual/auto/quick saves are distinct, listed, loadable, and versioned.
- Corruption is detected and backed up rather than silently loaded.
- Meta/world/run scopes do not leak into each other.
- Death flow preserves intended persistent state and blocks invalid reloads.
...
- Write a short `docs/game/build-plans/evidence/save-load-persistence-contract-review.md` with existing files, missing files, and chosen extension seams.
...
- Add requirement rows for REQ-SL-001..012 with status transitions: Proposed -> Approved -> Validated.
