# Task 10: Audio, Music, Spatial Sound, Voice & Meta Events — Standalone E2E Package Plan

Generated: 2026-06-25T19:59:51-04:00

## Objective
Deliver a complete, production-grade, independently testable package for **Audio, Music, Spatial Sound, Voice & Meta Events**.

## Source requirements
- Package requirement range: REQ-AU-001..010
...
## Concept lock
Greenfield production audio layer: bus layout, ambient zones, SFX catalog, dynamic music layers, spatial attenuation/occlusion, voice/audio logs, and meta-events.

## Project Zomboid influence, translated in-character
PZ ambient tension, directional zombie sounds, meta events like helicopter/gunshots translated to distress signals, biomatter pulses, and ship system audio.
...
- SfxEventRouter
- DynamicMusicState
- SpatialAudioResolver
- MetaEventState

### Required data/config/resources
- audio bus config
- room-role ambience map
- SFX event catalog
- music layer rules
...
- room Area3D ambient zones
- threat/ship/UI SFX events
- music state machine

### Required UI/UX/player feedback
- audio settings panel
- subtitle/SFX caption options
- audio log playback UI

### Required asset/audio seams
- placeholder SFX bank
- ambient loops
- music layer placeholders
- audio log placeholder clips
...
- SFX EVENT ROUTER PASS
- DYNAMIC MUSIC STATE PASS
- MAIN PLAYABLE AUDIO PASS

## Acceptance criteria
- All major gameplay events route through named audio events/buses.
- Ambient audio changes by room role and threat/system state.
- Dynamic music layers respond to exploration/tension/combat/critical vitals.
- Spatial attenuation/occlusion is deterministic and testable.
...
- Write a short `docs/game/build-plans/evidence/audio-music-spatial-contract-review.md` with existing files, missing files, and chosen extension seams.
...
- Add requirement rows for REQ-AU-001..010 with status transitions: Proposed -> Approved -> Validated.
