...
Your hub ship is trapped in a vast biomatter web — a cosmic Sargasso. From a
...
| 8 | Sargasso World & Scanner Display      | Complete (folded into 4) |
...
- `sargasso_world` + `world_snapshot` — Sargasso spatial registry.
...
- `scripts/ui/scanner_panel.gd` — Sargasso scanner.
...
├── AGENTS.md                    # Sargasso operating model (read first)
├── scenes/                      # .tscn scenes
