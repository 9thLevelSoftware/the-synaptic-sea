...
## Pre-polish program (started 2026-07-22; mechanical packages through #323)
...
**Landed (PRs #78–#323, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=393 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#323):**
...
- Regression marker contract commands=393 in 06_validation_plan.md
