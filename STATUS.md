...
## Pre-polish program (started 2026-07-22; mechanical packages through #432)
...
**Landed (PRs #78–#432, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=443 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#432):**
...
- Regression marker contract commands=443 in 06_validation_plan.md
