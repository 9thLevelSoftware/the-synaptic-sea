...
## Pre-polish program (started 2026-07-22; mechanical packages through #500)
...
**Landed (PRs #78–#500, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=550 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#500):**
...
- Regression marker contract commands=550 in 06_validation_plan.md
