...
`closed` in the inventory (`--check` 191/191; regression bundle `commands=170 clean_output=true`
...
every remaining orphan, and Tranche 4 closed the UI-wiring cluster (audio-log panel, difficulty
label, panel menu-modal guard, voice clip_path wiring); see
