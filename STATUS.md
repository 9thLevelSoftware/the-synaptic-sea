...
## Pre-polish program (started 2026-07-22; mechanical packages through #225)
...
**Landed (PRs #78–#225, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=335 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#225):**
...
- Regression marker contract commands=335 in 06_validation_plan.md
