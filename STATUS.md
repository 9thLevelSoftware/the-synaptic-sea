...
## Pre-polish program (started 2026-07-22; mechanical packages through #478)
...
**Landed (PRs #78–#478, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=512 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#478):**
...
- Regression marker contract commands=512 in 06_validation_plan.md
