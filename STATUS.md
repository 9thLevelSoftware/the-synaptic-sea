...
## Pre-polish program (started 2026-07-22; mechanical packages through #480)
...
**Landed (PRs #78–#480, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=516 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#480):**
...
- Regression marker contract commands=516 in 06_validation_plan.md
