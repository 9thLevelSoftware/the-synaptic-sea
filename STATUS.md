...
## Pre-polish program (started 2026-07-22; mechanical packages through #247)
...
**Landed (PRs #78–#247, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=347 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#247):**
...
- Regression marker contract commands=347 in 06_validation_plan.md
