...
## Pre-polish program (started 2026-07-22; mechanical packages through #520)
...
**Landed (PRs #78–#520, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=615 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#520):**
...
- Regression marker contract commands=615 in 06_validation_plan.md
