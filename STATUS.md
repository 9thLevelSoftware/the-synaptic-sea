...
## Pre-polish program (started 2026-07-22; mechanical packages through #360)
...
**Landed (PRs #78–#360, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=412 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#360):**
...
- Regression marker contract commands=412 in 06_validation_plan.md
