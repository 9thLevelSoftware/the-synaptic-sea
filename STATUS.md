...
## Pre-polish program (started 2026-07-22; mechanical packages through #239)
...
**Landed (PRs #78–#239, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=343 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#239):**
...
- Regression marker contract commands=343 in 06_validation_plan.md
