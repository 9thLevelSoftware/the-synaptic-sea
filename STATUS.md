...
## Pre-polish program (started 2026-07-22; mechanical packages through #394)
...
**Landed (PRs #78–#394, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=427 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#394):**
...
- Regression marker contract commands=427 in 06_validation_plan.md
