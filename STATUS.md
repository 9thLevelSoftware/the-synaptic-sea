...
## Pre-polish program (started 2026-07-22; mechanical packages through #315)
...
**Landed (PRs #78–#315, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=387 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#315):**
...
- Regression marker contract commands=387 in 06_validation_plan.md
