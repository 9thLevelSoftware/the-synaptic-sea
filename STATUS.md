...
## Pre-polish program (started 2026-07-22; mechanical packages through #273)
...
**Landed (PRs #78–#273, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=358 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#273):**
...
- Regression marker contract commands=358 in 06_validation_plan.md
