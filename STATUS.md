...
## Pre-polish program (started 2026-07-22; mechanical packages through #128)
...
**Landed (PRs #78–#128, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=265 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#128):**
...
- Regression marker contract commands=265 in 06_validation_plan.md
