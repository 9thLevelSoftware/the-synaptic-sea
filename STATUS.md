...
## Pre-polish program (started 2026-07-22; mechanical packages through #515)
...
**Landed (PRs #78–#515, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=590 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#515):**
...
- Regression marker contract commands=590 in 06_validation_plan.md
