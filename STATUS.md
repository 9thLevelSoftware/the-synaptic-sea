...
## Pre-polish program (started 2026-07-22; mechanical packages through #131)
...
**Landed (PRs #78–#131, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=267 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#131):**
...
- Regression marker contract commands=267 in 06_validation_plan.md
