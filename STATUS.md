...
## Pre-polish program (started 2026-07-22; mechanical packages through #229)
...
**Landed (PRs #78–#229, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=338 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#229):**
...
- Regression marker contract commands=338 in 06_validation_plan.md
