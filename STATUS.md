...
## Pre-polish program (started 2026-07-22; mechanical packages through #289)
...
**Landed (PRs #78–#289, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=366 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#289):**
...
- Regression marker contract commands=366 in 06_validation_plan.md
