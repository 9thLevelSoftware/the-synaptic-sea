...
## Pre-polish program (started 2026-07-22; mechanical packages through #257)
...
**Landed (PRs #78–#257, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=351 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#257):**
...
- Regression marker contract commands=351 in 06_validation_plan.md
