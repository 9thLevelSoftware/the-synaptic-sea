...
## Pre-polish program (started 2026-07-22; mechanical packages through #279)
...
**Landed (PRs #78–#279, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=361 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#279):**
...
- Regression marker contract commands=361 in 06_validation_plan.md
