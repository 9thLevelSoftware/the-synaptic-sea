...
## Pre-polish program (started 2026-07-22; mechanical packages through #255)
...
**Landed (PRs #78–#255, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=350 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#255):**
...
- Regression marker contract commands=350 in 06_validation_plan.md
