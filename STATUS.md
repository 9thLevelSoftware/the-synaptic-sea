...
## Pre-polish program (started 2026-07-22; mechanical packages through #217)
...
**Landed (PRs #78–#217, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=329 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#217):**
...
- Regression marker contract commands=329 in 06_validation_plan.md
