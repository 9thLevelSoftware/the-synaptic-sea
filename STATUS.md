...
## Pre-polish program (started 2026-07-22; mechanical packages through #464)
...
**Landed (PRs #78–#464, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=484 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#464):**
...
- Regression marker contract commands=484 in 06_validation_plan.md
