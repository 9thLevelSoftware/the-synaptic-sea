...
`SYNAPTIC_SEA REGRESSION PASS commands=301 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).
...
- Regression marker contract commands=301 in 06_validation_plan.md
