...
## Pre-polish program (started 2026-07-22; mechanical packages through #340)
...
**Landed (PRs #78–#340, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=401 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#340):**
...
- Regression marker contract commands=401 in 06_validation_plan.md
