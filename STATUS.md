...
## Pre-polish program (started 2026-07-22; mechanical packages through #325)
...
**Landed (PRs #78–#325, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=394 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#325):**
...
- Regression marker contract commands=394 in 06_validation_plan.md
