...
## Pre-polish program (started 2026-07-22; mechanical packages through #310)
...
**Landed (PRs #78–#310, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=385 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#310):**
...
- Regression marker contract commands=385 in 06_validation_plan.md
