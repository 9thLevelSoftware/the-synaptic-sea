...
## Pre-polish program (started 2026-07-22; mechanical packages through #455)
...
**Landed (PRs #78–#455, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=460 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#455):**
...
- Regression marker contract commands=460 in 06_validation_plan.md
