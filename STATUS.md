...
`SYNAPTIC_SEA REGRESSION PASS commands=321 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).
...
- repair_full_system / fabricate_part / compound_stimulant training emit smokes
- Regression marker contract commands=321 in 06_validation_plan.md
