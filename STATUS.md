...
## Pre-polish program (started 2026-07-22; mechanical packages through #271)
...
**Landed (PRs #78–#271, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=357 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#271):**
...
- Regression marker contract commands=357 in 06_validation_plan.md
