...
## Pre-polish program (started 2026-07-22; mechanical packages through #522)
...
**Landed (PRs #78–#522, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=622 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#522):**
...
- Regression marker contract commands=622 in 06_validation_plan.md
