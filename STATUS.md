...
## Pre-polish program (started 2026-07-22; mechanical packages through #390)
...
**Landed (PRs #78–#390, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=425 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#390):**
...
- Regression marker contract commands=425 in 06_validation_plan.md
