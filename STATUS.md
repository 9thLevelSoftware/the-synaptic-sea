...
## Pre-polish program (started 2026-07-22; mechanical packages through #414)
...
**Landed (PRs #78–#414, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=435 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#414):**
...
- Regression marker contract commands=435 in 06_validation_plan.md
