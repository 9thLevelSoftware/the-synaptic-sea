...
## Pre-polish program (started 2026-07-22; mechanical packages through #490)
...
**Landed (PRs #78–#490, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=537 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#490):**
...
- Regression marker contract commands=537 in 06_validation_plan.md
