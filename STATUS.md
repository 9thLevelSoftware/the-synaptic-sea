...
## Pre-polish program (started 2026-07-22; mechanical packages through #291)
...
**Landed (PRs #78–#291, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=367 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#291):**
...
- Regression marker contract commands=367 in 06_validation_plan.md
