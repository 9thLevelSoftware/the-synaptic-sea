...
## Pre-polish program (started 2026-07-22; mechanical packages through #488)
...
**Landed (PRs #78–#488, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=532 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#488):**
...
- Regression marker contract commands=532 in 06_validation_plan.md
