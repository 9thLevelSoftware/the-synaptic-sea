...
## Pre-polish program (started 2026-07-22; mechanical packages through #462)
...
**Landed (PRs #78–#462, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=480 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#462):**
...
- Regression marker contract commands=480 in 06_validation_plan.md
