...
## Pre-polish program (started 2026-07-22; mechanical packages through #508)
...
**Landed (PRs #78–#508, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=563 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#508):**
...
- Regression marker contract commands=563 in 06_validation_plan.md
