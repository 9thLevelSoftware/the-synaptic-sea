...
## Pre-polish program (started 2026-07-22; mechanical packages through #484)
...
**Landed (PRs #78–#484, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=524 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#484):**
...
- Regression marker contract commands=524 in 06_validation_plan.md
