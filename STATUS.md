...
## Pre-polish program (started 2026-07-22; mechanical packages through #327)
...
**Landed (PRs #78–#327, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=395 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#327):**
...
- Regression marker contract commands=395 in 06_validation_plan.md
