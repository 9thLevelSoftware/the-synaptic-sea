...
## Pre-polish program (started 2026-07-22; mechanical packages through #275)
...
**Landed (PRs #78–#275, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=359 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#275):**
...
- Regression marker contract commands=359 in 06_validation_plan.md
