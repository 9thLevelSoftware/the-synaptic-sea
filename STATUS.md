...
## Pre-polish program (started 2026-07-22; mechanical packages through #510)
...
**Landed (PRs #78–#510, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=567 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#510):**
...
- Regression marker contract commands=567 in 06_validation_plan.md
