...
## Pre-polish program (started 2026-07-22; mechanical packages through #400)
...
**Landed (PRs #78–#400, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=430 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#400):**
...
- Regression marker contract commands=430 in 06_validation_plan.md
