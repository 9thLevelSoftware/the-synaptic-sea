...
## Pre-polish program (started 2026-07-22; mechanical packages through #259)
...
**Landed (PRs #78–#259, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=352 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#259):**
...
- Regression marker contract commands=352 in 06_validation_plan.md
