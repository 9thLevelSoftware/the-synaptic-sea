...
## Pre-polish program (started 2026-07-22; mechanical packages through #446)
...
**Landed (PRs #78–#446, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=450 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#446):**
...
- Regression marker contract commands=450 in 06_validation_plan.md
