...
## Pre-polish program (started 2026-07-22; mechanical packages through #243)
...
**Landed (PRs #78–#243, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=345 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#243):**
...
- Regression marker contract commands=345 in 06_validation_plan.md
