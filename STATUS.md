...
## Pre-polish program (started 2026-07-22; mechanical packages through #313)
...
**Landed (PRs #78–#313, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=386 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#313):**
...
- Regression marker contract commands=386 in 06_validation_plan.md
