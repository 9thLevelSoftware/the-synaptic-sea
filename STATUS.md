...
## Pre-polish program (started 2026-07-22; mechanical packages through #342)
...
**Landed (PRs #78–#342, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=402 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#342):**
...
- Regression marker contract commands=402 in 06_validation_plan.md
