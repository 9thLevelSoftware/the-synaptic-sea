...
## Pre-polish program (started 2026-07-22; mechanical packages through #346)
...
**Landed (PRs #78–#346, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=404 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#346):**
...
- Regression marker contract commands=404 in 06_validation_plan.md
