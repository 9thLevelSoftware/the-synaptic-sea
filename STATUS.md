...
## Pre-polish program (started 2026-07-22; mechanical packages through #362)
...
**Landed (PRs #78–#362, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=413 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#362):**
