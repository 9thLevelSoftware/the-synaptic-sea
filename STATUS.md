...
## Pre-polish program (started 2026-07-22; mechanical packages through #502)
...
**Landed (PRs #78–#502, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=551 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#502):**
...
- Regression marker contract commands=551 in 06_validation_plan.md
