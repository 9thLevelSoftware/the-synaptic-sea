...
## Pre-polish program (started 2026-07-22; mechanical packages through #474)
...
**Landed (PRs #78–#474, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=504 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#474):**
...
- Regression marker contract commands=504 in 06_validation_plan.md
