...
## Pre-polish program (started 2026-07-22; mechanical packages through #438)
...
**Landed (PRs #78–#438, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=446 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#438):**
...
- Regression marker contract commands=446 in 06_validation_plan.md
