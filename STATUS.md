...
## Pre-polish program (started 2026-07-22; mechanical packages through #263)
...
**Landed (PRs #78–#263, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=354 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#263):**
...
- Regression marker contract commands=354 in 06_validation_plan.md
