...
## Pre-polish program (started 2026-07-22; mechanical packages through #336)
...
**Landed (PRs #78–#336, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=399 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#336):**
...
- Regression marker contract commands=399 in 06_validation_plan.md
