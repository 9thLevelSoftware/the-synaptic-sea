...
## Pre-polish program (started 2026-07-22; mechanical packages through #388)
...
**Landed (PRs #78–#388, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=424 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#388):**
...
- Regression marker contract commands=424 in 06_validation_plan.md
