...
## Pre-polish program (started 2026-07-22; mechanical packages through #344)
...
**Landed (PRs #78–#344, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=403 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#344):**
...
- Regression marker contract commands=403 in 06_validation_plan.md
