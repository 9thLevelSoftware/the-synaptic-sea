...
## Pre-polish program (started 2026-07-22; mechanical packages through #420)
...
**Landed (PRs #78–#420, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=437 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#420):**
...
- Regression marker contract commands=437 in 06_validation_plan.md
