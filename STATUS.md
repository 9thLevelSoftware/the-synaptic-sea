...
## Pre-polish program (started 2026-07-22; mechanical packages through #277)
...
**Landed (PRs #78–#277, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=360 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#277):**
...
- Regression marker contract commands=360 in 06_validation_plan.md
