...
## Pre-polish program (started 2026-07-22; mechanical packages through #350)
...
**Landed (PRs #78–#350, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=407 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#350):**
...
- Regression marker contract commands=407 in 06_validation_plan.md
