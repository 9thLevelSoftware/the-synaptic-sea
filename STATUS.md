...
## Pre-polish program (started 2026-07-22; mechanical packages through #211)
...
**Landed (PRs #78–#211, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=325 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#211):**
...
- Regression marker contract commands=325 in 06_validation_plan.md
