...
## Pre-polish program (started 2026-07-22; mechanical packages through #470)
...
**Landed (PRs #78–#470, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=496 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#470):**
...
- Regression marker contract commands=496 in 06_validation_plan.md
