...
## Pre-polish program (started 2026-07-22; mechanical packages through #338)
...
**Landed (PRs #78–#338, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=400 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#338):**
...
- Regression marker contract commands=400 in 06_validation_plan.md
