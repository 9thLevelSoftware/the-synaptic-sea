...
## Pre-polish program (started 2026-07-22; mechanical packages through #187)
...
**Landed (PRs #78–#187, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=312 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#187):**
...
- Regression marker contract commands=312 in 06_validation_plan.md
