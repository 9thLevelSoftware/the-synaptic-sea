...
## Pre-polish program (started 2026-07-22; mechanical packages through #486)
...
**Landed (PRs #78–#486, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=528 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#486):**
...
- Regression marker contract commands=528 in 06_validation_plan.md
