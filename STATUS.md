...
## Pre-polish program (started 2026-07-22; mechanical packages through #384)
...
**Landed (PRs #78–#384, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=422 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#384):**
...
- Regression marker contract commands=422 in 06_validation_plan.md
