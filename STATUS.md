...
## Pre-polish program (started 2026-07-22; mechanical packages through #221)
...
**Landed (PRs #78–#221, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=332 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#221):**
...
- Regression marker contract commands=332 in 06_validation_plan.md
