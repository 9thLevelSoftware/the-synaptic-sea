...
## Pre-polish program (started 2026-07-22; mechanical packages through #448)
...
**Landed (PRs #78–#448, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=451 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#448):**
...
- Regression marker contract commands=451 in 06_validation_plan.md
