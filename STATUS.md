...
## Pre-polish program (started 2026-07-22; mechanical packages through #293)
...
**Landed (PRs #78–#293, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=368 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#293):**
...
- Regression marker contract commands=368 in 06_validation_plan.md
