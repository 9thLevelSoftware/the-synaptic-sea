...
## Pre-polish program (started 2026-07-22; mechanical packages through #402)
...
**Landed (PRs #78–#402, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=431 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#402):**
...
- Regression marker contract commands=431 in 06_validation_plan.md
