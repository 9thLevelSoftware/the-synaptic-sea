...
## Pre-polish program (started 2026-07-22; mechanical packages through #440)
...
**Landed (PRs #78–#440, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=447 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#440):**
...
- Regression marker contract commands=447 in 06_validation_plan.md
