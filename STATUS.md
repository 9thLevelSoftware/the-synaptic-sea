...
## Pre-polish program (started 2026-07-22; mechanical packages through #354)
...
**Landed (PRs #78–#354, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=409 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#354):**
...
- Regression marker contract commands=409 in 06_validation_plan.md
