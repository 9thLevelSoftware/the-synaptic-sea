...
## Pre-polish program (started 2026-07-22; mechanical packages through #521)
...
**Landed (PRs #78–#521, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=621 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#521):**
...
- Regression marker contract commands=621 in 06_validation_plan.md
