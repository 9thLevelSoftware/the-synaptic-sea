...
## Pre-polish program (started 2026-07-22; mechanical packages through #352)
...
**Landed (PRs #78–#352, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=408 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#352):**
...
- Regression marker contract commands=408 in 06_validation_plan.md
