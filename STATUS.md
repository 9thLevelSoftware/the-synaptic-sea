...
## Pre-polish program (started 2026-07-22; mechanical packages through #426)
...
**Landed (PRs #78–#426, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=440 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#426):**
...
- Regression marker contract commands=440 in 06_validation_plan.md
