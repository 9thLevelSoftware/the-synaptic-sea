...
## Pre-polish program (started 2026-07-22; mechanical packages through #436)
...
**Landed (PRs #78–#436, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=445 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#436):**
...
- Regression marker contract commands=445 in 06_validation_plan.md
