...
## Pre-polish program (started 2026-07-22; mechanical packages through #412)
...
**Landed (PRs #78–#412, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=434 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#412):**
...
- Regression marker contract commands=434 in 06_validation_plan.md
