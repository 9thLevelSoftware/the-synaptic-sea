...
## Pre-polish program (started 2026-07-22; mechanical packages through #459)
...
**Landed (PRs #78–#459, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=472 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#459):**
...
- Regression marker contract commands=472 in 06_validation_plan.md
