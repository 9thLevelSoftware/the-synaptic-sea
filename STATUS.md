...
## Pre-polish program (started 2026-07-22; mechanical packages through #281)
...
**Landed (PRs #78–#281, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=362 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#281):**
...
- Regression marker contract commands=362 in 06_validation_plan.md
