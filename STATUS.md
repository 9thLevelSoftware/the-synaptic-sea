...
## Pre-polish program (started 2026-07-22; mechanical packages through #356)
...
**Landed (PRs #78–#356, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=410 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#356):**
...
- Regression marker contract commands=410 in 06_validation_plan.md
