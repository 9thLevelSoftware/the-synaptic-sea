...
## Pre-polish program (started 2026-07-22; mechanical packages through #410)
...
**Landed (PRs #78–#410, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=433 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#410):**
...
- Regression marker contract commands=433 in 06_validation_plan.md
