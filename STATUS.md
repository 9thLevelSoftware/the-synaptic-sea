...
## Pre-polish program (started 2026-07-22; mechanical packages through #370)
...
**Landed (PRs #78–#370, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=416 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#370):**
...
- Regression marker contract commands=416 in 06_validation_plan.md
