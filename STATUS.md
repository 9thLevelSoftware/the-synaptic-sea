...
## Pre-polish program (started 2026-07-22; mechanical packages through #418)
...
**Landed (PRs #78–#418, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=436 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#418):**
...
- Regression marker contract commands=436 in 06_validation_plan.md
