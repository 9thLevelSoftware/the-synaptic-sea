...
## Pre-polish program (started 2026-07-22; mechanical packages through #358)
...
**Landed (PRs #78–#358, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=411 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#358):**
...
- Regression marker contract commands=411 in 06_validation_plan.md
