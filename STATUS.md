...
## Pre-polish program (started 2026-07-22; mechanical packages through #231)
...
**Landed (PRs #78–#231, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=339 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#231):**
...
- Regression marker contract commands=339 in 06_validation_plan.md
