...
## Pre-polish program (started 2026-07-22; mechanical packages through #305)
...
**Landed (PRs #78–#305, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=379 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#305):**
...
- Regression marker contract commands=379 in 06_validation_plan.md
