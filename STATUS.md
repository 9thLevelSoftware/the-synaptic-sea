...
## Pre-polish program (started 2026-07-22; mechanical packages through #428)
...
**Landed (PRs #78–#428, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=441 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#428):**
...
- Regression marker contract commands=441 in 06_validation_plan.md
