...
## Pre-polish program (started 2026-07-22; mechanical packages through #295)
...
**Landed (PRs #78–#295, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=369 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#295):**
...
- Regression marker contract commands=369 in 06_validation_plan.md
