...
## Pre-polish program (started 2026-07-22; mechanical packages through #297)
...
**Landed (PRs #78–#297, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=370 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#297):**
...
- Regression marker contract commands=370 in 06_validation_plan.md
