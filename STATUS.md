...
## Pre-polish program (started 2026-07-22; mechanical packages through #496)
...
**Landed (PRs #78–#496, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=546 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#496):**
...
- Regression marker contract commands=546 in 06_validation_plan.md
