...
## Pre-polish program (started 2026-07-22; mechanical packages through #506)
...
**Landed (PRs #78–#506, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=559 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#506):**
...
- Regression marker contract commands=559 in 06_validation_plan.md
