...
## Pre-polish program (started 2026-07-22; mechanical packages through #442)
...
**Landed (PRs #78–#442, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=448 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#442):**
...
- Regression marker contract commands=448 in 06_validation_plan.md
