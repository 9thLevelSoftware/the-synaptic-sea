...
## Pre-polish program (started 2026-07-22; mechanical packages through #283)
...
**Landed (PRs #78–#283, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=363 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#283):**
...
- Regression marker contract commands=363 in 06_validation_plan.md
