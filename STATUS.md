...
## Pre-polish program (started 2026-07-22; mechanical packages through #392)
...
**Landed (PRs #78–#392, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=426 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#392):**
...
- Regression marker contract commands=426 in 06_validation_plan.md
