...
## Pre-polish program (started 2026-07-22; mechanical packages through #372)
...
**Landed (PRs #78–#372, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=417 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#372):**
...
- Regression marker contract commands=417 in 06_validation_plan.md
