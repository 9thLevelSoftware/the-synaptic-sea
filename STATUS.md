...
## Pre-polish program (started 2026-07-22; mechanical packages through #227)
...
**Landed (PRs #78–#227, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=336 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#227):**
...
- Regression marker contract commands=336 in 06_validation_plan.md
