...
## Pre-polish program (started 2026-07-22; mechanical packages through #329)
...
**Landed (PRs #78–#329, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=396 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#329):**
