...
## Pre-polish program (started 2026-07-22; mechanical packages through #334)
...
**Landed (PRs #78–#334, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=398 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#334):**
...
- Regression marker contract commands=398 in 06_validation_plan.md
