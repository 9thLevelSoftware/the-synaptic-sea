...
## Pre-polish program (started 2026-07-22; mechanical packages through #472)
...
**Landed (PRs #78–#472, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=500 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#472):**
...
- Regression marker contract commands=500 in 06_validation_plan.md
