...
## Pre-polish program (started 2026-07-22; mechanical packages through #386)
...
**Landed (PRs #78–#386, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=423 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#386):**
...
- Regression marker contract commands=423 in 06_validation_plan.md
