...
## Pre-polish program (started 2026-07-22; mechanical packages through #494)
...
**Landed (PRs #78–#494, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=545 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#494):**
...
- Regression marker contract commands=545 in 06_validation_plan.md
