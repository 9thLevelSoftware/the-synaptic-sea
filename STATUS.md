...
## Pre-polish program (started 2026-07-22; mechanical packages through #398)
...
**Landed (PRs #78–#398, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=429 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#398):**
...
- Regression marker contract commands=429 in 06_validation_plan.md
