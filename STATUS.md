...
## Pre-polish program (started 2026-07-22; mechanical packages through #235)
...
**Landed (PRs #78–#235, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=341 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#235):**
...
- Regression marker contract commands=341 in 06_validation_plan.md
