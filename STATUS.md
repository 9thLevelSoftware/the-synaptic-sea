...
## Pre-polish program (started 2026-07-22; mechanical packages through #317)
...
**Landed (PRs #78–#317, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=388 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#317):**
...
- Regression marker contract commands=388 in 06_validation_plan.md
