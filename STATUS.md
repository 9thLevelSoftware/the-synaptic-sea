...
## Pre-polish program (started 2026-07-22; mechanical packages through #378)
...
**Landed (PRs #78–#378, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=420 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#378):**
...
- Regression marker contract commands=420 in 06_validation_plan.md
