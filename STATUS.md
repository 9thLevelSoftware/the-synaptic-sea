...
## Pre-polish program (started 2026-07-22; mechanical packages through #492)
...
**Landed (PRs #78–#492, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=541 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#492):**
...
- Regression marker contract commands=541 in 06_validation_plan.md
