...
## Pre-polish program (started 2026-07-22; mechanical packages through #265)
...
**Landed (PRs #78–#265, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=355 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#265):**
...
- Regression marker contract commands=355 in 06_validation_plan.md
