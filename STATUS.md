...
## Pre-polish program (started 2026-07-22; mechanical packages through #219)
...
**Landed (PRs #78–#219, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=331 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#219):**
...
- Regression marker contract commands=331 in 06_validation_plan.md
