...
`SYNAPTIC_SEA REGRESSION PASS commands=292 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).
...
- Regression marker contract commands=292 in 06_validation_plan.md
