...
## Pre-polish program (started 2026-07-22; mechanical packages through #396)
...
**Landed (PRs #78–#396, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=428 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#396):**
...
- Regression marker contract commands=428 in 06_validation_plan.md
