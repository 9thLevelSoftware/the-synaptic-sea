...
## Pre-polish program (started 2026-07-22; mechanical packages through #233)
...
**Landed (PRs #78–#233, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=340 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#233):**
...
- Regression marker contract commands=340 in 06_validation_plan.md
