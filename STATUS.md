...
## Pre-polish program (started 2026-07-22; mechanical packages through #365)
...
**Landed (PRs #78–#365, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=414 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#365):**
...
- Regression marker contract commands=414 in 06_validation_plan.md
