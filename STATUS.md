...
## Pre-polish program (started 2026-07-22; mechanical packages through #516)
...
**Landed (PRs #78–#516, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=593 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#516):**
...
- Regression marker contract commands=593 in 06_validation_plan.md
