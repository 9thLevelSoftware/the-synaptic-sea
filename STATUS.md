...
## Pre-polish program (started 2026-07-22; mechanical packages through #299)
...
**Landed (PRs #78–#299, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=371 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#299):**
...
- Regression marker contract commands=371 in 06_validation_plan.md
