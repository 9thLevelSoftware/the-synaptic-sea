...
## Pre-polish program (started 2026-07-22; mechanical packages through #303)
...
**Landed (PRs #78–#303, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=375 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#303):**
...
- Regression marker contract commands=375 in 06_validation_plan.md
