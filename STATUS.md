...
## Pre-polish program (started 2026-07-22; mechanical packages through #476)
...
**Landed (PRs #78–#476, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=508 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#476):**
...
- Regression marker contract commands=508 in 06_validation_plan.md
