...
## Pre-polish program (started 2026-07-22; mechanical packages through #444)
...
**Landed (PRs #78–#444, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=449 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#444):**
...
- Regression marker contract commands=449 in 06_validation_plan.md
