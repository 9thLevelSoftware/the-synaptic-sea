...
## Pre-polish program (started 2026-07-22; mechanical packages through #245)
...
**Landed (PRs #78–#245, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=346 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#245):**
...
- Regression marker contract commands=346 in 06_validation_plan.md
