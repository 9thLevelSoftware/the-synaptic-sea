...
## Pre-polish program (started 2026-07-22; mechanical packages through #468)
...
**Landed (PRs #78–#468, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=492 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#468):**
...
- Regression marker contract commands=492 in 06_validation_plan.md
