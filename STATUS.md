...
## Pre-polish program (started 2026-07-22; mechanical packages through #241)
...
**Landed (PRs #78–#241, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=344 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#241):**
...
- Regression marker contract commands=344 in 06_validation_plan.md
