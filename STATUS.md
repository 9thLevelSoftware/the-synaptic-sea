...
## Pre-polish program (started 2026-07-22; mechanical packages through #517)
...
**Landed (PRs #78–#517, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=600 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#517):**
...
- Regression marker contract commands=600 in 06_validation_plan.md
