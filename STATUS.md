...
## Pre-polish program (started 2026-07-22; mechanical packages through #237)
...
**Landed (PRs #78–#237, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=342 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#237):**
...
- Regression marker contract commands=342 in 06_validation_plan.md
