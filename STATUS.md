...
## Pre-polish program (started 2026-07-22; mechanical packages through #430)
...
**Landed (PRs #78–#430, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=442 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#430):**
...
- Regression marker contract commands=442 in 06_validation_plan.md
