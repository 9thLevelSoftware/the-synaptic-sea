...
## Pre-polish program (started 2026-07-22; mechanical packages through #332)
...
**Landed (PRs #78–#332, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=397 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#332):**
...
- Regression marker contract commands=397 in 06_validation_plan.md
