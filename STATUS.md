...
## Pre-polish program (started 2026-07-22; mechanical packages through #215)
...
**Landed (PRs #78–#215, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=327 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#215):**
...
- Regression marker contract commands=327 in 06_validation_plan.md
