...
## Pre-polish program (started 2026-07-22; mechanical packages through #404)
...
**Landed (PRs #78–#404, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=432 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#404):**
...
- Plant crop soft-fails consume after production_blocked
- Regression marker contract commands=432 in 06_validation_plan.md
