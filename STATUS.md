...
## Pre-polish program (started 2026-07-22; mechanical packages through #261)
...
**Landed (PRs #78–#261, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=353 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#261):**
...
- Regression marker contract commands=353 in 06_validation_plan.md
