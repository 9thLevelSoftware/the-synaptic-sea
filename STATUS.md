...
## Pre-polish program (started 2026-07-22; mechanical packages through #376)
...
**Landed (PRs #78–#376, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=419 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#376):**
...
- Regression marker contract commands=419 in 06_validation_plan.md
