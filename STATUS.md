...
## Pre-polish program (started 2026-07-22; mechanical packages through #249)
...
**Landed (PRs #78–#249, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=348 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#249):**
...
- Regression marker contract commands=348 in 06_validation_plan.md
