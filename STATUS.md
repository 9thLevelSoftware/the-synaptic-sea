...
## Pre-polish program (started 2026-07-22; mechanical packages through #374)
...
**Landed (PRs #78–#374, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=418 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#374):**
...
- Regression marker contract commands=418 in 06_validation_plan.md
