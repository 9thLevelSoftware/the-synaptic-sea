...
## Pre-polish program (started 2026-07-22; mechanical packages through #319)
...
**Landed (PRs #78–#319, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=390 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#319):**
...
- Regression marker contract commands=390 in 06_validation_plan.md
