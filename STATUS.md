...
## Pre-polish program (started 2026-07-22; mechanical packages through #191)
...
**Landed (PRs #78–#191, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=315 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#191):**
...
- Regression marker contract commands=315 in 06_validation_plan.md
