...
## Pre-polish program (started 2026-07-22; mechanical packages through #466)
...
**Landed (PRs #78–#466, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=488 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#466):**
...
- Regression marker contract commands=488 in 06_validation_plan.md
