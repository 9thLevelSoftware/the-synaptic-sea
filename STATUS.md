...
## Pre-polish program (started 2026-07-22; mechanical packages through #269)
...
**Landed (PRs #78–#269, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=356 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#269):**
...
- Regression marker contract commands=356 in 06_validation_plan.md
