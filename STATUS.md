...
## Pre-polish program (started 2026-07-22; mechanical packages through #321)
...
**Landed (PRs #78–#321, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=391 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#321):**
...
- Regression marker contract commands=391 in 06_validation_plan.md
