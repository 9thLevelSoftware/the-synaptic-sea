...
## Pre-polish program (started 2026-07-22; mechanical packages through #348)
...
**Landed (PRs #78–#348, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=406 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#348):**
...
- Regression marker contract commands=406 in 06_validation_plan.md
