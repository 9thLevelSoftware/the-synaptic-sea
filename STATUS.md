...
## Pre-polish program (started 2026-07-22; mechanical packages through #308)
...
**Landed (PRs #78–#308, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=382 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#308):**
...
- Regression marker contract commands=382 in 06_validation_plan.md
