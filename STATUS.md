...
## Pre-polish program (started 2026-07-22; mechanical packages through #482)
...
**Landed (PRs #78–#482, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=520 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#482):**
...
- Regression marker contract commands=520 in 06_validation_plan.md
