...
## Pre-polish program (started 2026-07-22; mechanical packages through #498)
...
**Landed (PRs #78–#498, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=549 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#498):**
...
- Regression marker contract commands=549 in 06_validation_plan.md
