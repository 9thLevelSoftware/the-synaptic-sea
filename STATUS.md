...
## Pre-polish program (started 2026-07-22; mechanical packages through #368)
...
**Landed (PRs #78–#368, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=415 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#368):**
...
- Regression marker contract commands=415 in 06_validation_plan.md
