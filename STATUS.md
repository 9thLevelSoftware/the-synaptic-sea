...
`SYNAPTIC_SEA REGRESSION PASS commands=297 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).
...
- Work progress pulses UI_WORK_PROGRESS SFX with strip noise
- Regression marker contract commands=297 in 06_validation_plan.md
