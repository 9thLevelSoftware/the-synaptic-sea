...
## Pre-polish program (started 2026-07-22; mechanical packages through #504)
...
**Landed (PRs #78–#504, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=555 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#504):**
...
- Regression marker contract commands=555 in 06_validation_plan.md
