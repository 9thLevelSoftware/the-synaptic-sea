...
## Pre-polish program (started 2026-07-22; mechanical packages through #183)
...
**Landed (PRs #78–#183, 2026-07-22 → 2026-07-23):**
...
`SYNAPTIC_SEA REGRESSION PASS commands=311 clean_output=true` (marker-based; set `GODOT`/`ROOT` on Windows).

**Post-INT hardening (PRs #112–#183):**
...
- Regression marker contract commands=311 in 06_validation_plan.md
