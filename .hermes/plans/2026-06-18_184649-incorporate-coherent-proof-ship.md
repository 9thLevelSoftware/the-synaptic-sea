...
- The repo is not currently a git repository from the shell. Use `/tmp/sargasso_coherent_incorporation_no_git_changes.log` as the fallback change ledger if `git rev-parse --is-inside-work-tree` fails.
...
- Fallback no-git ledger: `/tmp/sargasso_coherent_incorporation_no_git_changes.log`
...
**Files:**
- Create: `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/validation/main_coherent_boot_smoke.gd`
...
- Modify: `/Users/christopherwilloughby/the-sargasso-of-stars/scenes/main.tscn`
...
**Files:**
- Create: `/Users/christopherwilloughby/the-sargasso-of-stars/scripts/validation/main_coherent_capture.gd`
...
for script in \
  ...
  /Users/christopherwilloughby/.local/bin/godot-4.6.2 --headless --path /Users/christopherwilloughby/the-sargasso-of-stars --script "$script"
done
...
- **No-git fallback.** The project is not a git repo in the shell. Subagents must not invent repo-local audit logs; use `/tmp/sargasso_coherent_incorporation_no_git_changes.log` exactly.
