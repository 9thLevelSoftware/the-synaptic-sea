...
classify() {
  case "$1" in
    ...
    r10a_run7_save_transition_smoke|r10a_world7_snapshot_smoke|r10a_world6_layout_projection_smoke|r10a_integrity_admission_smoke|r10a_ceiling_clearance_smoke|\
