...
CARD_ALLOWLISTS: dict[str, list[str]] = {
    ...
    "P04": [
        *[f"scripts/systems/{name}.gd" for name in ("ship_inventory", "cargo_transfer", "cart_state", "equipment_state", "deconstruction_resolver", "ship_instance")],
        *[f"scripts/tools/{name}.gd" for name in ("cargo_hold_control", "cart_control", "work_yield_drop", "loot_container")],
        *[f"scripts/ui/{name}.gd" for name in ("inventory_panel", "inventory_row", "inventory_drop_zone")],
        COORDINATOR, f"{VALIDATION}fc_p04_smoke.gd",
    ],
    "P05": [
        "scripts/systems/item_quality_effects.gd", "data/items/quality_effects.json",
        *[f"scripts/systems/{name}.gd" for name in ("quality_tier_resolver", "work_action_resolver", "consumable_state", "component_mount_resolver")],
        "scripts/ui/inventory_row.gd", "scripts/ui/recipe_picker_panel.gd", f"{VALIDATION}fc_p05_smoke.gd",
    ],
    "P06": [
    ...
    "P11": [
        *[f"scripts/systems/{name}.gd" for name in ("component_catalog", "component_placement_state", "component_mount_resolver", "ship_modification_state")],
        ...
        f"{VALIDATION}ship_modification_smoke.gd", f"{VALIDATION}fc_p11_smoke.gd",
    ],
    "P12": [
        *[f"scripts/systems/{name}.gd" for name in ("ship_work_transaction", "work_action_state", "work_action_driver", "work_action_channel", "work_action_resolver", "component_mount_resolver")],
        ...
        "scripts/ui/work_action_hud_panel.gd", WORK_ACTION_CATALOG, f"{VALIDATION}fc_p12_smoke.gd",
    ],
    "P13": [
...
CARD_SMOKES = {
    "P00": ["fc_p00_ceiling_lifetime_smoke.gd", "fc_p00_native_arc_smoke.gd", "derelict_arc_smoke.gd", "crafting_state_smoke.gd", "module_integrity_consequences_smoke.gd", "repair_loop_smoke.gd", "main_playable_slice_station_craft_smoke.gd", "pilot_switch_smoke.gd"],
    "P03": [
    ...
    "P04": ["cargo_transfer_smoke.gd", "equipment_carts_smoke.gd", "main_playable_slice_inventory_ui_smoke.gd"],
    ...
    "P07": ["crafting_state_smoke.gd", "station_state_smoke.gd"],
