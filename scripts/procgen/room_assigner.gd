...
const ROOM_FOOTPRINT_OPTIONS: Dictionary = {
	...
	"corridor":       [Vector2i(1, 2), Vector2i(1, 3), Vector2i(1, 4), Vector2i(1, 5)],
	"engineering":    [Vector2i(2, 2), Vector2i(3, 2)],
	"bridge":         [Vector2i(2, 2), Vector2i(3, 2)],
	"cargo":          [Vector2i(2, 2), Vector2i(3, 3), Vector2i(2, 3)],
	"bay":            [Vector2i(2, 2), Vector2i(3, 3), Vector2i(2, 3)],
	"medical":        [Vector2i(2, 1), Vector2i(2, 2)],
	"crew_quarters":  [Vector2i(2, 1), Vector2i(2, 2)],
