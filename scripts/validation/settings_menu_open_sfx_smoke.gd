...
## Opening settings menu routes UI_PANEL_OPEN.
## Marker: SETTINGS MENU OPEN SFX PASS open=true sfx=true
...
func _validate() -> void:
	...
	print("SETTINGS MENU OPEN SFX PASS open=true sfx=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("SETTINGS MENU OPEN SFX FAIL: %s" % msg)
	finished = true
	quit(1)
