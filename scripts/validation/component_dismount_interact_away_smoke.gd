...
## Marker: COMPONENT DISMOUNT INTERACT AWAY PASS away=true start=true tick=true stripped=true yield=true
...
func _tick() -> void:
	...
	print("COMPONENT DISMOUNT INTERACT AWAY PASS away=true start=true tick=true stripped=true yield=true")
	finished = true
	quit(0)
...
func _fail(msg: String) -> void:
	print("COMPONENT DISMOUNT INTERACT AWAY FAIL: %s" % msg)
	finished = true
	quit(1)
