...
## Marker: SHIP CATCHUP PASS web_grew=true hull_degraded=true timestamp_stamped=true bounded=true
...
func _validate() -> void:
	...
	print("SHIP CATCHUP PASS web_grew=true hull_degraded=true timestamp_stamped=true bounded=true")
	_cleanup_and_quit(0)
...
func _fail(reason: String) -> void:
	push_error("SHIP CATCHUP FAIL reason=%s" % reason)
	_cleanup_and_quit(1)
