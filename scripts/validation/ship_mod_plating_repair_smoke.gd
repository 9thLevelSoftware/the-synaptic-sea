...
## Marker: SHIP MOD PLATING REPAIR PASS install=true repair=true
...
func _validate() -> void:
	...
	print("SHIP MOD PLATING REPAIR PASS install=true repair=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("SHIP MOD PLATING REPAIR FAIL: %s" % msg)
	finished = true
	quit(1)
