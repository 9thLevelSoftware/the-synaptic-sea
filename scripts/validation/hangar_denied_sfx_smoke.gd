...
## Hangar dock/launch refuse routes UI_PANEL_CLOSE.
## Marker: HANGAR DENIED SFX PASS deny=true sfx=true
...
func _validate() -> void:
	...
	print("HANGAR DENIED SFX PASS deny=true sfx=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("HANGAR DENIED SFX FAIL: %s" % msg)
	finished = true
	quit(1)
