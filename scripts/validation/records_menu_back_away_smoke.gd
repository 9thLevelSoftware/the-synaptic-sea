...
## Records menu back SFX works with away_from_start true.
## Marker: RECORDS MENU BACK AWAY PASS away=true back=true sfx=true
...
func _validate() -> void:
	...
	print("RECORDS MENU BACK AWAY PASS away=true back=true sfx=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("RECORDS MENU BACK AWAY FAIL: %s" % msg)
	finished = true
	quit(1)
