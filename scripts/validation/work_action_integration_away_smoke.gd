...
## Marker: WORK ACTION INTEGRATION AWAY PASS driver=true hud=true wounds=true shipmod=true cut=true
...
func _validate() -> void:
	...
	print("WORK ACTION INTEGRATION AWAY PASS away=true driver=true hud=true wounds=true shipmod=true cut=true")
	quit(0)
...
func _fail(msg: String) -> void:
	finished = true
	print("WORK ACTION INTEGRATION AWAY FAIL: %s" % msg)
	quit(1)
