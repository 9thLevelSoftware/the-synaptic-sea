...
## Records menu back navigates with UI_PANEL_CLOSE.
## Marker: RECORDS MENU BACK SFX PASS back=true sfx=true
...
func _validate() -> void:
	...
	print("RECORDS MENU BACK SFX PASS back=true sfx=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("RECORDS MENU BACK SFX FAIL: %s" % msg)
	finished = true
	quit(1)
