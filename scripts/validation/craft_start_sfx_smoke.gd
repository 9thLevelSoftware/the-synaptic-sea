...
## Station craft start routes SFX_TOOL_USE.
## Marker: CRAFT START SFX PASS start=true sfx=true
...
func _validate() -> void:
	...
	print("CRAFT START SFX PASS start=true sfx=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("CRAFT START SFX FAIL: %s" % msg)
	finished = true
	quit(1)
