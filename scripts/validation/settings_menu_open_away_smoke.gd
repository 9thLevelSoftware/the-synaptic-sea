...
## Settings menu open SFX works with away_from_start true.
## Marker: SETTINGS MENU OPEN AWAY PASS away=true open=true sfx=true
...
func _validate() -> void:
	...
	print("SETTINGS MENU OPEN AWAY PASS away=true open=true sfx=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("SETTINGS MENU OPEN AWAY FAIL: %s" % msg)
	finished = true
	quit(1)
