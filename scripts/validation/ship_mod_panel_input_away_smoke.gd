...
## Marker: SHIP MOD PANEL INPUT AWAY PASS open=true select=true close=true
...
func _validate() -> void:
	...
	print("SHIP MOD PANEL INPUT AWAY PASS away=true open=true select=true close=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("SHIP MOD PANEL INPUT AWAY FAIL: %s" % msg)
	finished = true
	quit(1)
