...
## Marker: LOOT SEARCH SFX PASS search=true sfx=true
...
func _validate() -> void:
	...
	playable._on_loot_container_searched("sfx_loot_test", [{"item_id": "scrap_metal", "qty": 1}], null)
	...
	print("LOOT SEARCH SFX PASS search=true sfx=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("LOOT SEARCH SFX FAIL: %s" % msg)
	finished = true
	quit(1)
