...
## Marker: WORK SUPPRESS SFX LIVE PASS complete=true sfx=true
...
func _validate() -> void:
	...
	print("WORK SUPPRESS SFX LIVE PASS complete=true sfx=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("WORK SUPPRESS SFX LIVE FAIL: %s" % msg)
	finished = true
	quit(1)
