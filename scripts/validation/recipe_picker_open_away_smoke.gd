...
## Recipe picker open SFX works with away_from_start true.
## Marker: RECIPE PICKER OPEN AWAY PASS away=true open=true sfx=true
...
func _validate() -> void:
	...
	print("RECIPE PICKER OPEN AWAY PASS away=true open=true sfx=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("RECIPE PICKER OPEN AWAY FAIL: %s" % msg)
	finished = true
	quit(1)
