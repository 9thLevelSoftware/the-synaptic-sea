...
## Marker: SHIP MOD INSTALL KEY PASS install=true catalog=true uninstall=true
...
func _validate() -> void:
	...
	print("SHIP MOD INSTALL KEY PASS install=true catalog=true uninstall=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("SHIP MOD INSTALL KEY FAIL: %s" % msg)
	finished = true
	quit(1)
