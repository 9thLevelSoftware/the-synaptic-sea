...
## Marker: COMPONENT MOUNT SFX LIVE PASS dismount=true sfx=true
...
func _finish() -> void:
	...
	print("COMPONENT MOUNT SFX LIVE PASS dismount=true sfx=true")
	finished = true
	quit(0)
...
func _fail(msg: String) -> void:
	print("COMPONENT MOUNT SFX LIVE FAIL: %s" % msg)
	finished = true
	quit(1)
