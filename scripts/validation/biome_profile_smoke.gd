...
#
# Asserts:
#   1. BiomeProfile.from_dict() round-trips the abyssal_sargasso
...
func _initialize() -> void:
	# --- Case 1: Round-trip abyssal_sargasso ---
	...
	if abyssal == null:
		...
		quit(1)
		return
	if str(abyssal.id) != "abyssal_sargasso":
	...
	var biome_pool: Array[String] = ["abyssal_sargasso", "breach_field", "dead_fleet"]
	...
	if str(roundtrip.get("id", "")) != "abyssal_sargasso":
