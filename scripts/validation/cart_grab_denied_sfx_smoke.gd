...
## Cart grab with unknown cart_id routes UI_PANEL_CLOSE.
## Marker: CART GRAB DENIED SFX PASS deny=true sfx=true
...
func _validate() -> void:
	...
	print("CART GRAB DENIED SFX PASS deny=true sfx=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("CART GRAB DENIED SFX FAIL: %s" % msg)
	finished = true
	quit(1)
