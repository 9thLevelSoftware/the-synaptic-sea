...
## Reload with no ammo / full mag routes UI_PANEL_CLOSE; empty weapon also denies.
## Marker: RELOAD DENIED SFX PASS deny=true sfx=true
...
func _validate() -> void:
	...
	# Unarmed / empty primary — reload denied.
	...
	print("RELOAD DENIED SFX PASS deny=true sfx=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("RELOAD DENIED SFX FAIL: %s" % msg)
	finished = true
	quit(1)
