...
## Marker: REPAIR VALIDATION CHANNELING AWAY PASS start=true soft_block_false=true
...
func _validate() -> void:
	...
	print("REPAIR VALIDATION CHANNELING AWAY PASS away=true start=true soft_block_false=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("REPAIR VALIDATION CHANNELING AWAY FAIL: %s" % msg)
	finished = true
	quit(1)
