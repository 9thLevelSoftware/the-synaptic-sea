...
## Marker: WORK VERB SFX MULTI AWAY PASS weld=true pry=true
...
func _validate() -> void:
	...
	print("WORK VERB SFX MULTI AWAY PASS away=true weld=true pry=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("WORK VERB SFX MULTI AWAY FAIL: %s" % msg)
	finished = true
	quit(1)
