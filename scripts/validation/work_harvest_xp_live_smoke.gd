...
## Marker: WORK HARVEST XP LIVE PASS start=true complete=true xp=true
...
func _validate() -> void:
	...
	print("WORK HARVEST XP LIVE PASS start=true complete=true xp=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("WORK HARVEST XP LIVE FAIL: %s" % msg)
	finished = true
	quit(1)
