...
## Marker: WORK WELD SKILL CONTEXT AWAY PASS skill=true start=true
...
func _validate() -> void:
	...
	print("WORK WELD SKILL CONTEXT AWAY PASS away=true skill=true start=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("WORK WELD SKILL CONTEXT AWAY FAIL: %s" % msg)
	finished = true
	quit(1)
