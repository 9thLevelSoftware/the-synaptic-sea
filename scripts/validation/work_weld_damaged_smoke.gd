...
## Marker: WORK WELD DAMAGED PASS start=true repair=true consume=true
...
func _validate() -> void:
	...
	print("WORK WELD DAMAGED PASS start=true repair=true consume=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("WORK WELD DAMAGED FAIL: %s" % msg)
	finished = true
	quit(1)
