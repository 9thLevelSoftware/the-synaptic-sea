...
## Marker: COMPONENT MARKERS AWAY PASS wired=true count=true rebuild=true
...
func _validate() -> void:
	...
	print("COMPONENT MARKERS AWAY PASS away=true wired=true count=true rebuild=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("COMPONENT MARKERS AWAY FAIL: %s" % msg)
	finished = true
	quit(1)
