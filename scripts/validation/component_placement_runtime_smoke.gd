...
## Marker: COMPONENT PLACEMENT RUNTIME PASS wired=true populate_or_empty=true round_trip=true
...
func _validate() -> void:
	...
	print("COMPONENT PLACEMENT RUNTIME PASS wired=true populate_or_empty=true round_trip=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("COMPONENT PLACEMENT RUNTIME FAIL: %s" % msg)
	finished = true
	quit(1)
