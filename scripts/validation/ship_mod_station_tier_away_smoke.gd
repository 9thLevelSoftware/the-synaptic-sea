...
## Marker: SHIP MOD STATION TIER AWAY PASS install=true tier=true uninstall=true
...
func _validate() -> void:
	...
	print("SHIP MOD STATION TIER AWAY PASS away=true install=true tier=true uninstall=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("SHIP MOD STATION TIER AWAY FAIL: %s" % msg)
	finished = true
	quit(1)
