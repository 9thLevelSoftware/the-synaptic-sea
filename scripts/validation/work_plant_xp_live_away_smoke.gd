...
## Marker: WORK PLANT XP LIVE AWAY PASS start=true complete=true xp=true
...
func _validate() -> void:
	...
	print("WORK PLANT XP LIVE AWAY PASS away=true start=true complete=true xp=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("WORK PLANT XP LIVE AWAY FAIL: %s" % msg)
	finished = true
	quit(1)
