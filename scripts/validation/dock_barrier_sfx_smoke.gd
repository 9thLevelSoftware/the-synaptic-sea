...
## Dock barrier breach open routes SFX_DOOR_OPEN.
## Marker: DOCK BARRIER SFX PASS open=true sfx=true
...
func _validate() -> void:
	...
	playable._on_dock_barrier_opened("barrier_sfx_test")
	...
	print("DOCK BARRIER SFX PASS open=true sfx=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("DOCK BARRIER SFX FAIL: %s" % msg)
	finished = true
	quit(1)
