...
## ScannerPanel.open routes UI_PANEL_OPEN.
## Marker: SCANNER OPEN SFX PASS open=true sfx=true
...
func _validate() -> void:
	...
	print("SCANNER OPEN SFX PASS open=true sfx=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("SCANNER OPEN SFX FAIL: %s" % msg)
	finished = true
	quit(1)
