...
## Marker: CUT MODULE SCENE PASS cut=true damaged=true sparse=true
...
func _validate() -> void:
	...
	print("CUT MODULE SCENE PASS cut=true damaged=true sparse=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("CUT MODULE SCENE FAIL: %s" % msg)
	finished = true
	quit(1)
