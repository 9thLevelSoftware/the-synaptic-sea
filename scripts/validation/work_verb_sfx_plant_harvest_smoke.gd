...
## Marker: WORK VERB SFX PLANT HARVEST PASS plant=true harvest=true
...
func _validate() -> void:
	...
	print("WORK VERB SFX PLANT HARVEST PASS plant=true harvest=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("WORK VERB SFX PLANT HARVEST FAIL: %s" % msg)
	finished = true
	quit(1)
