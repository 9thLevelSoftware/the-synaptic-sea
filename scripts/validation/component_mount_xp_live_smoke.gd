...
## Live dismount + remount WorkActions emit salvage/repair training XP.
## Marker: COMPONENT MOUNT XP LIVE PASS dismount=true remount=true xp=true
...
func _finish() -> void:
	...
	print("COMPONENT MOUNT XP LIVE PASS dismount=true remount=true xp=true")
	finished = true
	quit(0)
...
func _fail(msg: String) -> void:
	print("COMPONENT MOUNT XP LIVE FAIL: %s" % msg)
	finished = true
	quit(1)
