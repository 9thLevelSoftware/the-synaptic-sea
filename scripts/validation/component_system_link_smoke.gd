		...
		"rooms": [
			{
				...
				"wall_slots": [
					...
					{"against_wall": true, "cell": "(1,1)", "component_slot_profile_id": "wall_console_mount_v1"},
				],
			...
			},
			{
				...
				"room_role": "bridge",
				"wall_slots": [
					{"against_wall": true, "cell": "(2,0)", "component_slot_profile_id": "wall_console_mount_v1"},
					{"against_wall": true, "cell": "(2,1)", "component_slot_profile_id": "wall_console_mount_v1"},
				],
				"center_slots": [],
			},
		],
