...
##
## Pass marker: DERELICT FIRE ZONE MARKER AWAY PASS boarded=true marker_position_used=true spec_meta=true fallback_intact=true
...
func _validate() -> void:
	...
	print("DERELICT FIRE ZONE MARKER AWAY PASS away=true boarded=true marker_position_used=true spec_meta=true fallback_intact=true")
	_cleanup(0)
...
func _fail(reason: String) -> void:
	push_error("DERELICT FIRE ZONE MARKER AWAY FAIL reason=%s" % reason)
	finished = true
	_cleanup(1)
