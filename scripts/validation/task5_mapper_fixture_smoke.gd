...
func _init() -> void:
	...
	for condition in ["intact", "damaged", "fractured"]:
		...
		var bundle: Dictionary = {"site_ir": site_ir, "gameplay_ir": {"legacy_slice": {"schema_version": "1.1.0", "document_kind": "ship_gameplay_slice", "start_room":"crew_quarters_01", "goal_room":"crew_quarters_01", "critical_path":[], "fire_zones":[], "objectives":[], "loot_containers":[], "summary":"fixture"}}, "presentation_ir": {"kit_id": "ship_structural_v0"}, "request": {"difficulty_id": "standard"}}
