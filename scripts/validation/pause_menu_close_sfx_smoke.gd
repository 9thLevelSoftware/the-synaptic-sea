...
## Closing pause menu via close_all routes UI_PANEL_CLOSE.
## Marker: PAUSE MENU CLOSE SFX PASS close=true sfx=true
...
func _validate() -> void:
	...
	print("PAUSE MENU CLOSE SFX PASS close=true sfx=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("PAUSE MENU CLOSE SFX FAIL: %s" % msg)
	finished = true
	quit(1)
