...
## Opening pause menu routes UI_PANEL_OPEN.
## Marker: PAUSE MENU OPEN SFX PASS open=true sfx=true
...
func _validate() -> void:
	...
	# Ensure in-play so pause open path is valid.
	if playable.menu_coordinator.menu_state != null:
	...
	print("PAUSE MENU OPEN SFX PASS open=true sfx=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("PAUSE MENU OPEN SFX FAIL: %s" % msg)
	finished = true
	quit(1)
