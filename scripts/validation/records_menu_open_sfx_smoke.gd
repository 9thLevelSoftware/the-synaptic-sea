...
## Opening records menu routes UI_PANEL_OPEN.
## Marker: RECORDS MENU OPEN SFX PASS open=true sfx=true
...
func _validate() -> void:
	...
	print("RECORDS MENU OPEN SFX PASS open=true sfx=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("RECORDS MENU OPEN SFX FAIL: %s" % msg)
	finished = true
	quit(1)
