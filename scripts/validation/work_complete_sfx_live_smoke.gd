...
## Marker: WORK COMPLETE SFX LIVE PASS complete=true audio=true route=true
...
func _validate() -> void:
	...
	print("WORK COMPLETE SFX LIVE PASS complete=true audio=true route=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("WORK COMPLETE SFX LIVE FAIL: %s" % msg)
	finished = true
	quit(1)
