...
## Marker: WORK VERB SFX PATCH SPLICE PASS patch=true splice=true
...
func _validate() -> void:
	...
	print("WORK VERB SFX PATCH SPLICE PASS patch=true splice=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("WORK VERB SFX PATCH SPLICE FAIL: %s" % msg)
	finished = true
	quit(1)
