...
## Pause menu resume close routes UI_PANEL_CLOSE.
## Marker: MENU CONFIRM RESUME SFX PASS resume=true sfx=true
...
func _validate() -> void:
	...
	# Exercise the same close+SFX pair resume confirm uses.
	...
	print("MENU CONFIRM RESUME SFX PASS resume=true sfx=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("MENU CONFIRM RESUME SFX FAIL: %s" % msg)
	finished = true
	quit(1)
