...
## Marker: SHIP MOD OVERBUDGET POWER AWAY PASS over=true unpowered=true ok=true
...
func _validate() -> void:
	...
	print("SHIP MOD OVERBUDGET POWER AWAY PASS away=true over=true unpowered=true ok=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("SHIP MOD OVERBUDGET POWER AWAY FAIL: %s" % msg)
	finished = true
	quit(1)
