...
## Marker: PRODUCTION START SFX PASS start=true sfx=true
...
func _validate() -> void:
	...
	playable._on_production_started("hydroponics", "seed_packet")
	...
	print("PRODUCTION START SFX PASS start=true sfx=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("PRODUCTION START SFX FAIL: %s" % msg)
	finished = true
	quit(1)
