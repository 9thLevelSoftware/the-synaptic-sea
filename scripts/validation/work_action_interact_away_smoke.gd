...
## Marker: WORK ACTION INTERACT AWAY PASS start=true tick=true complete=true nearest=true
...
func _tick() -> void:
	...
	print("WORK ACTION INTERACT AWAY PASS away=true start=true tick=true complete=true nearest=true")
	finished = true
	quit(0)
...
func _fail(msg: String) -> void:
	print("WORK ACTION INTERACT AWAY FAIL: %s" % msg)
	finished = true
	quit(1)
