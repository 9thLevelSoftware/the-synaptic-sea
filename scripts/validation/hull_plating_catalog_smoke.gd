...
## Marker: HULL PLATING CATALOG PASS catalog=true install=true bonus=true
...
func _validate() -> void:
	...
	print("HULL PLATING CATALOG PASS catalog=true install=true bonus=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("HULL PLATING CATALOG FAIL: %s" % msg)
	finished = true
	quit(1)
