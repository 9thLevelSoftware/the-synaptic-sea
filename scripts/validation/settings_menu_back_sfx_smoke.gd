...
## Settings menu back navigates with UI_PANEL_CLOSE.
## Marker: SETTINGS MENU BACK SFX PASS back=true sfx=true
...
func _validate() -> void:
	...
	print("SETTINGS MENU BACK SFX PASS back=true sfx=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("SETTINGS MENU BACK SFX FAIL: %s" % msg)
	finished = true
	quit(1)
