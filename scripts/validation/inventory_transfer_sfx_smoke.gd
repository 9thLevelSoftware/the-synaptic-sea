...
## Marker: INVENTORY TRANSFER SFX PASS transfer=true sfx=true
...
func _validate() -> void:
	...
	print("INVENTORY TRANSFER SFX PASS transfer=true sfx=true")
	quit(0)
...
func _fail(msg: String) -> void:
	print("INVENTORY TRANSFER SFX FAIL: %s" % msg)
	finished = true
	quit(1)
