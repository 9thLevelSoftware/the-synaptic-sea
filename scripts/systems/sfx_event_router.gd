...
static var EVENT_CATALOG: Dictionary = {
	...
	String(AudioEventSeam.SFX_WORK_CUT): {"bus": AudioEventSeam.BUS_SFX, "volume_db": -4.0, "cooldown": 0.15, "caption": "Cutting"},
	String(AudioEventSeam.SFX_WORK_WELD): {"bus": AudioEventSeam.BUS_SFX, "volume_db": -4.0, "cooldown": 0.15, "caption": "Welding"},
	String(AudioEventSeam.SFX_WORK_PATCH): {"bus": AudioEventSeam.BUS_SFX, "volume_db": -5.0, "cooldown": 0.15, "caption": "Patching"},
	String(AudioEventSeam.SFX_WORK_UNBOLT): {"bus": AudioEventSeam.BUS_SFX, "volume_db": -6.0, "cooldown": 0.12, "caption": "Unbolting"},
	String(AudioEventSeam.SFX_WORK_PRY): {"bus": AudioEventSeam.BUS_SFX, "volume_db": -5.0, "cooldown": 0.12, "caption": "Prying"},
	String(AudioEventSeam.SFX_WORK_SPLICE): {"bus": AudioEventSeam.BUS_SFX, "volume_db": -6.0, "cooldown": 0.12, "caption": "Splicing"},
	String(AudioEventSeam.SFX_WORK_HARVEST): {"bus": AudioEventSeam.BUS_SFX, "volume_db": -8.0, "cooldown": 0.20, "caption": "Harvested"},
	String(AudioEventSeam.SFX_WORK_PLANT): {"bus": AudioEventSeam.BUS_SFX, "volume_db": -10.0, "cooldown": 0.20, "caption": "Planted"},
	String(AudioEventSeam.SFX_WORK_MOUNT): {"bus": AudioEventSeam.BUS_SFX, "volume_db": -6.0, "cooldown": 0.15, "caption": "Mounted"},
	String(AudioEventSeam.SFX_COMBAT_HIT): {"bus": AudioEventSeam.BUS_SFX, "volume_db": -3.0, "cooldown": 0.08, "caption": ""},
	String(AudioEventSeam.SFX_COMBAT_THREAT_ALERT): {"bus": AudioEventSeam.BUS_SFX, "volume_db": -2.0, "cooldown": 1.0, "caption": "Threat detected"},
	String(AudioEventSeam.SFX_WOUND_BANDAGE): {"bus": AudioEventSeam.BUS_SFX, "volume_db": -8.0, "cooldown": 0.20, "caption": "Bandaged"},
	String(AudioEventSeam.SFX_WOUND_TREAT): {"bus": AudioEventSeam.BUS_SFX, "volume_db": -6.0, "cooldown": 0.25, "caption": "Treated wound"},
	String(AudioEventSeam.SFX_CRAFT_COMPLETE): {"bus": AudioEventSeam.BUS_SFX, "volume_db": -5.0, "cooldown": 0.20, "caption": "Craft complete"},
	String(AudioEventSeam.SFX_REPAIR_COMPLETE): {"bus": AudioEventSeam.BUS_SFX, "volume_db": -5.0, "cooldown": 0.20, "caption": "Repair complete"},
	String(AudioEventSeam.SFX_SANITY_AMBIENT): {"bus": AudioEventSeam.BUS_SFX, "volume_db": -14.0, "cooldown": 1.0, "caption": ""},
	String(AudioEventSeam.SFX_SANITY_HUD): {"bus": AudioEventSeam.BUS_SFX, "volume_db": -10.0, "cooldown": 0.8, "caption": ""},
	String(AudioEventSeam.SFX_SANITY_PHANTOM): {"bus": AudioEventSeam.BUS_SFX, "volume_db": -12.0, "cooldown": 1.2, "caption": ""},
	...
	String(AudioEventSeam.UI_SHIP_MOD_OPEN): {"bus": AudioEventSeam.BUS_UI, "volume_db": -8.0, "cooldown": 0.15, "caption": ""},
