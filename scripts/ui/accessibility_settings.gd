...
##
## The Sargasso playable slice keeps pure gameplay state in RefCounted / Resource
...
## 1. The `SARGASSO_TEXT_SCALE` environment variable (CI /).
## 2. The headless overrides `sargasso/accessibility/text_scale` project setting.
